...
function menu(){
    ...
    html = html +'<ul>'
    html = html +'<li><a href="Class.jsp">Class Registration</a></li>';
    html = html +'<li><a href="SearchStudentInfoServlet">Student Search</a></li>';
    html = html +'<li><a href="ClassNameServlet">Student Registration</a></li>';
    html = html +'</ul>';
    html = html +'</li>';
    html = html +'<li id="no-child">';
    html = html +'<a href="User_Search.jsp" style="font-weight:bold;">User Management</a>';
    html = html +'</li>';
    html = html +'</ul>';
    html = html +'</div>';
